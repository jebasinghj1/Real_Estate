...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <motion.div
        className="relative z-10 max-w-7xl mx-auto px-6 md:px-14 py-8 md:py-12 w-full"
        style={{ rotateX, rotateY, transformStyle: "preserve-3d" }}
      >
        {/* Top Badge */}
        <motion.div
        ...
        >
          <motion.span
            ...
            transition={{ duration: 1, delay: 0.2, ease: EASE_LUXE }}
          />
          <span className="font-mono text-[10px] tracking-[0.25em] text-yellow-500/80 uppercase font-medium">
            ECR · Mahabalipuram · Est. 2024
          </span>
        </motion.div>
        ...
        <motion.h1
          className="font-serif font-light text-white leading-[0.9] mb-4"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.2, ease: EASE_LUXE }}
        >
          <span className="block text-[clamp(42px,6vw,90px)] tracking-tight drop-shadow-lg">
            An escape
          </span>
          <span className="block text-[clamp(36px,5vw,80px)] italic text-yellow-400 font-normal drop-shadow-[0_4px_20px_rgba(255,215,0,0.3)]">
            into green.
          </span>
        </motion.h1>
        ...
        {/* Subtitle - Reduced */}
        <motion.p
          className="font-sans font-light text-white/80 text-sm md:text-base max-w-xl mb-5 leading-relaxed tracking-wide"
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.5, ease: EASE_LUXE }}
        >
        ...
        {/* Villa Options Panel - More Compact */}
        <motion.div
          className="max-w-2xl mb-5 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.7, ease: EASE_LUXE }}
        >
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-2xl md:text-3xl font-serif text-yellow-400 font-light">4,800</span>
                  <span className="text-[10px] text-white/40 font-light">SQFT</span>
                </div>
                <h3 className="text-sm md:text-base text-white/80 font-serif font-light">2 BHK Luxury Villa</h3>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-2xl md:text-3xl font-serif text-yellow-400 font-bold">₹ 1</span>
                  <span className="text-sm md:text-base text-white/60 font-light">Cr</span>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-2xl md:text-3xl font-serif text-yellow-400 font-light">9,600</span>
                  <span className="text-[10px] text-white/40 font-light">SQFT</span>
                </div>
                <h3 className="text-sm md:text-base text-white/80 font-serif font-light">4 BHK Luxury Villa</h3>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-2xl md:text-3xl font-serif text-yellow-400 font-bold">₹ 2</span>
                  <span className="text-sm md:text-base text-white/60 font-light">Cr</span>
                </div>
              </div>
            </div>
        ...
        >
          <motion.a
            href="#contact"
            className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 bg-yellow-500 hover:bg-yellow-400 text-black font-sans text-[11px] tracking-[0.15em] uppercase rounded-full transition-all duration-300 shadow-lg shadow-yellow-500/20 hover:shadow-yellow-500/40 hover:-translate-y-1 font-medium"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.97 }}
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <motion.a
            href="https://wa.me/yournumber"
            className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 border border-white/20 hover:border-yellow-400/40 text-white hover:text-white font-sans text-[11px] tracking-[0.15em] uppercase rounded-full transition-all duration-300 bg-white/5 hover:bg-yellow-500/10 backdrop-blur-sm hover:-translate-y-1"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.97 }}
          >
      ...
      >
        <div className="flex flex-col items-center gap-1.5">
          <span className="font-mono text-[7px] text-white/20 uppercase tracking-[0.3em]">Scroll</span>
          <motion.div
